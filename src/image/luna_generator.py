...
LUNA_BASE_DESCRIPTION = """adult woman Luna Noir exactly 22 years old, mature feminine features, shoulder-length lavender purple bob haircut with perfectly straight blunt bangs across forehead, almond-shaped bright violet purple eyes with thick black winged eyeliner and long black lashes, very pale porcelain white skin with natural skin texture and visible pores, heart-shaped face with high defined cheekbones and delicate jawline, full pouty lips with dark plum matte lipstick, small straight nose, thin black leather choker necklace around neck, single small minimalist black outline snake tattoo on outer right forearm 8cm below elbow facing forward no other tattoos anywhere, hourglass figure with narrow waist, perky C-cup breasts with small light pink nipples centered on pale pink circular areolas 2cm diameter, flat toned stomach with subtle abs, wide feminine hips, thick toned thighs, round firm bubble butt, long shapely legs, 168cm tall 5foot6, athletic curvy body type, goth aesthetic, seductive confident expression, sultry gaze, photorealistic human features with sharp facial details"""

# Negative prompt to avoid inconsistencies and ensure adult appearance
NEGATIVE_PROMPT = "child, teen, teenager, young girl, underage, baby face, multiple people, crowd, group, different hair color, blonde hair, brunette hair, long hair, curly hair, different eye color, brown eyes, blue eyes, green eyes, tan skin, dark skin, tanned, muscular, overweight, flat chest, elderly, old, anime, cartoon, 3d render, cropped head, cropped feet, cut off, partial body, deformed, ugly, blurry, low quality, many tattoos, multiple tattoos, face tattoos, neck tattoos, chest tattoos, breast tattoos, stomach tattoos, back tattoos, leg tattoos, left arm tattoos, sleeve tattoos, arm sleeve, full sleeve, colorful tattoos, large tattoos, tribal tattoos, pixelated face, pixelated skin, low resolution face, blurry face, blurred eyes, blurred features, soft focus face, low detail face, censored, plastic skin, doll face, artificial, fake skin, smooth skin, airbrushed, oversaturated, deformed face, asymmetric face, crooked nose, deformed eyes, deformed breasts, deformed nipples, missing nipples, extra nipples, weird nipples, large nipples, large areolas, dark nipples, brown nipples, red nipples, inverted nipples, asymmetric nipples, unnatural nipples, pointy nipples, puffy nipples, cone shaped breasts, strange nipples, malformed nipples, distorted nipples, bad anatomy, bad breasts, ugly breasts, fake breasts, implants, bolt-on breasts"
...
def generate_luna_image(scenario: str, nsfw: bool = False, width: int = 1536, height: int = 1536, seed: int = None) -> bytes:
    ...
    if nsfw:
        # NSFW prompts - ULTRA-SPECIFIC nipple definition + high detail face + consistent tattoo
        full_prompt = f"{LUNA_BASE_DESCRIPTION}, {scenario}, professional nude photography, small light pink nipples centered on pale pink circular areolas, realistic breast anatomy, single small black snake tattoo on right forearm only, sharp detailed face, crisp facial features, high detail eyes and lips, natural lighting, NSFW explicit, photorealistic, 8K ultra HD, uncensored"
    else:
        full_prompt = f"{LUNA_BASE_DESCRIPTION}, {scenario}, single small black snake tattoo on right forearm only, sharp detailed face, crisp facial features, high detail eyes and lips, photorealistic, professional photography, 8K ultra HD, sharp focus"
