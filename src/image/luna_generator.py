...
def generate_luna_image(scenario: str, nsfw: bool = False, width: int = 1536, height: int = 1536, seed: int = None) -> bytes:
    ...
    if nsfw:
        # NSFW prompts - explicit but CONCISE, emphasizing NORMAL HUMAN anatomy
        full_prompt = f"{LUNA_BASE_DESCRIPTION}, {scenario}, photorealistic human photograph, realistic female anatomy, natural breasts, normal nipples, realistic skin, NSFW explicit, masterpiece, 8K, uncensored"
    else:
