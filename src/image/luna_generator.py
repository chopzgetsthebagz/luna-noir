...
def generate_luna_image(scenario: str, nsfw: bool = False, width: int = 1536, height: int = 1536, seed: int = None) -> bytes:
    ...
    if nsfw:
        # NSFW prompts - ULTRA-SPECIFIC nipple definition
        full_prompt = f"{LUNA_BASE_DESCRIPTION}, {scenario}, professional nude photography, small light pink nipples centered on pale pink circular areolas, realistic breast anatomy, single snake tattoo right forearm, natural lighting, NSFW explicit, photorealistic, 8K, uncensored"
    else:
