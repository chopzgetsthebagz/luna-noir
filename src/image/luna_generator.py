...
def generate_luna_image(scenario: str, nsfw: bool = False, width: int = 1536, height: int = 1536, seed: int = None) -> bytes:
    ...
    if nsfw:
        # NSFW prompts - explicit but CONCISE to avoid 502 errors, emphasizing natural anatomy
        full_prompt = f"{LUNA_BASE_DESCRIPTION}, {scenario}, photorealistic, anatomically correct body, natural breast shape, small pink nipples centered on round areolas, realistic skin pores, NSFW explicit, masterpiece, 8K, sharp focus, uncensored"
    else:
