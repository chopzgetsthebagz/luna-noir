...
def create_bot(token: str):
    ...
    async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        help_text = (
            ...
            "/generate – AI-generated photos of Luna 📸\n"
            "/preferences – view what Luna remembers about you 💜\n\n"
            "*System:*\n"
            ...
            "• 6 selfie moods (sultry, seductive, etc.)\n"
            "• 15+ scene types (bedroom, shower, etc.)\n"
            "• 8 nude poses (NSFW mode only)\n"
            "• 17 outfit presets\n"
            "• Custom descriptions\n\n"
            "*Feature Unlocks:*\n"
            "• Voice (L2 or Premium)\n"
    ...
    async def generate_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if not args:
            msg = (
                ...
                "*Scene Types (SFW):*\n"
                "bedroom, gaming, mirror, couch, outdoor\n\n"
                "*Scene Types (NSFW):*\n"
                "shower, topless, lingerie, fullbody, nude\n"
                "nude_lying, nude_sitting, nude_kneeling\n"
                "nude_bent_over, nude_side_view\n\n"
                "*Examples:*\n"
                "/generate selfie sultry\n"
                "/generate scene bedroom\n"
                "/generate scene nude_lying\n"
                "/generate custom lying on bed in purple lingerie\n\n"
                "💜 *NSFW mode enabled automatically in NSFW conversation mode*\n\n"
                "💡 *TIP:* Use /menu → 📸 Generate Image for easy buttons!"
            )
            await update.message.reply_text(escape_md(msg), parse_mode="MarkdownV2")
            return
